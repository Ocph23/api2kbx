...
function HomeController($scope, $state, $http, helperServices, AuthService, SweetAlert) {
  ...
  $scope.layanans = [
    { name: "Darat", picture: "/client/images/keybe-xpress-darat.png" },
    { name: "Laut", picture: "/client/images/keybe-xpress-laut.png" },
    { name: "Udara", picture: "/client/images/keybe-xpress-udara.png" },
    { name: "Kereta", picture: "/client/images/keybe-xpress-kereta.png" },
    { name: "Trucking", picture: "/client/images/keybe-layanan-trucking.png" },
    { name: "City Courier", picture: "/client/images/keybe-xpress-city-courier.png" },

  ];

  $scope.features = [
    { name: "Menjangkau Se-Indonesia Tanpa pihak ke 3", picture: "/client/images/1-300x300.png" },
    { name: "Real Time Tracking Tracking System", picture: "/client/images/real-time.png" },
    { name: "Harga Regular Service Premium", picture: "/client/images/keybe-logistik-tarif-murah.png" },
    { name: "Cepat dan Aman Sampai Tujuan", picture: "/client/images/keybe-xpress-truck.png" },
  ];
...
function TrackingController($scope, $stateParams, $http, helperServices, AuthService, SweetAlert) {
  ...
  $scope.tracking = (resi) => {
    ...
    $http({
      method: "get",
      url: helperServices.url + "/api/penjualan/stt/" + resi,
      headers: AuthService.getHeader()
    }).then(
      function successCallback(response) {
        $scope.model = response.data;
  ...
  $scope.products = [
    {
      ...
      picture: "/client/images/keybe-xpress-darat.png"
    },
    {
      id: 2,
      title: "LAUT",
      ...
      picture: "/client/images/keybe-xpress-laut.png"
    },
    {
      id: 3,
      title: "UDARA",
      ...
      picture: "/client/images/keybe-xpress-udara.png"
    },
    {
      id: 4,
      title: "KERETA API",
      ...
      picture: "/client/images/keybe-xpress-kereta.png"
    },
    {
      id: 5,
      title: "TRUCKING",
      ...
      picture: "/client/images/keybe-layanan-trucking.png"
    },
    {
      id: 6,
      title: "CITY COURIER",
      ...
      picture: "/client/images/keybe-xpress-city-courier.png"
    },
